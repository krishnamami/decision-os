...
Aggregate read-side queries over entity_states + decision_outputs. Reuses
the accord pool from ``api.accord.pipeline``.
"""
...
from api.accord.pipeline import PERSONAS, _f, _get_pool, _require_db
